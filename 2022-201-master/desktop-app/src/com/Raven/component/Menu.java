...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenu(EventMenu event) {
        ...
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/2.png")), "Predict the S/W Complexity", 1);
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Software Metric", 2);
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/4.png")), "Auto Refactoring Your Code", 3);
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/5.png")), "Code to Diagram Generator", 4);
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/6.png")), "Feedback", 5);
        addMenu(new ImageIcon(getClass().getResource("/com/raven/icon/7.png")), "About US", 6);
